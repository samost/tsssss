...
namespace Destructible2D.Inspector
{
	...
	public class D2dDestructible_Editor : D2dEditor
	{
		protected override void OnInspector()
		{
			...
			{
				BeginDisabled();
					EditorGUI.ObjectField(D2dHelper.Reserve(), "Alpha Tex", tgt.AlphaTex, typeof(Texture2D), true);
					...
					EditorGUI.ProgressBar(D2dHelper.Reserve(), tgt.AlphaRatio, "Alpha Ratio");
				EndDisabled();
			}
